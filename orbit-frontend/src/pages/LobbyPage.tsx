...
export default function LobbyPage({ rooms, loading, onRoomClick, onCreateClick, onJoinClick }: LobbyPageProps) {
    return (
                ...
                {loading
                    ...
                    : (
                        <div style={{ display: "flex", flexWrap: "wrap", gap: 16, alignItems: "flex-start" }}>
                            {rooms.map(r => <RoomCard key={r._id} room={r} onClick={() => onRoomClick(r)} />)}
